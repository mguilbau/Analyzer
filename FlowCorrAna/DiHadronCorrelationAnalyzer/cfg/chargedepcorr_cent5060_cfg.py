...
process.chargedepcorr_ana_HI.centmin = cms.int32(100)
process.chargedepcorr_ana_HI.centmax = cms.int32(120)
process.chargedepcorr_ana_HI.EffFileName = cms.string('TrackCorrections_HYDJET_5320_hiGenPixelTrk_cent50100.root')
process.chargedepcorr_ana_HI.ReCenterFileName = cms.string('recenter_cent5060_pttrg033_etaass445_eff1_zvtx1_bin01_new.root')
