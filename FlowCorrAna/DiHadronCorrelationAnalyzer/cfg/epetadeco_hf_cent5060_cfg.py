...
process.epetadeco_ana_HI_hfp.centmin = cms.int32(100)
process.epetadeco_ana_HI_hfp.centmax = cms.int32(120)
process.epetadeco_ana_HI_hfp.etatrgmin = cms.double(-5.0)
process.epetadeco_ana_HI_hfp.etatrgmax = cms.double(-4.0)
process.epetadeco_ana_HI_hfp.pttrgmin = cms.vdouble(0.0)
process.epetadeco_ana_HI_hfp.pttrgmax = cms.vdouble(10000.0)
process.epetadeco_ana_HI_hfp.TriggerID = cms.string('CaloTower')
