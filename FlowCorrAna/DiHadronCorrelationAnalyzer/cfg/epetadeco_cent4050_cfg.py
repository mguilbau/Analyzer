...
process.epetadeco_ana_HI_hfp.centmin = cms.int32(80)
process.epetadeco_ana_HI_hfp.centmax = cms.int32(100)
process.epetadeco_ana_HI_hfm.centmin = cms.int32(80)
process.epetadeco_ana_HI_hfm.centmax = cms.int32(100)
process.epetadeco_ana_HI_hfp.EffFileName = cms.string('TrackCorrections_HYDJET_5320_hiGenPixelTrk_cent3050.root')
process.epetadeco_ana_HI_hfm.EffFileName = cms.string('TrackCorrections_HYDJET_5320_hiGenPixelTrk_cent3050.root')
