...
process.chargedepcorr_ana_HI.centmin = cms.int32(40)
process.chargedepcorr_ana_HI.centmax = cms.int32(60)
process.chargedepcorr_ana_HI.EffFileName = cms.string('TrackCorrections_HYDJET_5320_hiGenPixelTrk_cent1030.root')
process.chargedepcorr_ana_HI.ReCenterFileName = cms.string('recenter_cent2030_pttrg033_etaass445_eff1_zvtx1_bin01_new.root')
