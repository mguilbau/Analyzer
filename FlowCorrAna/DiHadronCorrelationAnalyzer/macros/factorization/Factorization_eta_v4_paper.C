...
void Factorization_eta_v4_paper()
{
  const int nfiles = 8;
  ...
  filename[1] = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HIData_Minbias_2760GeV/merged/epetadeco_cent020_pttrg033_ptassallweight_etaass445_eff1_v42.root");
  filename[2] = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HIData_Minbias_2760GeV/merged/epetadeco_cent2060_pttrg033_ptassallweight_etaass445_eff1_v42.root");
  filename[3] = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HIData_Minbias_2760GeV/merged/epetadeco_cent2060_pttrg033_ptassallweight_etaass445_eff1_v42.root");

  filename[4] = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HIData_Minbias_2760GeV/merged/epetadeco_cent002_pttrg033_ptassallweight_etaass34_eff1_v42.root");
  filename[5] = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HIData_Minbias_2760GeV/merged/epetadeco_cent020_pttrg033_ptassallweight_etaass34_eff1_v42.root");
  filename[6] = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HIData_Minbias_2760GeV/merged/epetadeco_cent2060_pttrg033_ptassallweight_etaass34_eff1_v42.root");
  filename[7] = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HIData_Minbias_2760GeV/merged/epetadeco_cent2060_pttrg033_ptassallweight_etaass34_eff1_v42.root");
...
//    fit[jj][nbin] = new TF1(Form("fit_%d_%d",nbin,jj),"(1+[0]*(-x-4.5))/(1+[0]*(x-4.5))",0,3.0);
    if(jj<4) fit[jj][nbin] = new TF1(Form("fit_%d_%d",nbin,jj),"exp([0]*(-2*x))",0.0,2.5);
  ...
  TString histtitle[4] = {"0-0.2% centrality","0-20%","20-60%","30-60%"};
...
*/
  ...
  TH2D* htmp2 = new TH2D("htmp2",";#eta^{a};r_{4}(#eta^{a},#eta^{b})",100,-0.12,2.49,100,0.811,1.04);
  fixedFontHist(htmp2,1.,1.3);
  htmp2->GetXaxis()->CenterTitle();
  htmp2->GetYaxis()->CenterTitle();
  htmp2->GetYaxis()->SetTitleSize(htmp2->GetYaxis()->GetTitleSize()*1.2);
  htmp2->GetXaxis()->SetTitleSize(htmp2->GetXaxis()->GetTitleSize());
  htmp2->GetXaxis()->SetLabelSize(htmp2->GetXaxis()->GetLabelSize()*0.95);
  htmp2->GetXaxis()->SetNdivisions(510);
...
//    fit[jj+4][3]->Draw("Lsame");
  ...
  latex2->DrawLatex(0.24,0.88,"CMS PbPb #sqrt{s_{NN}} = 2.76 TeV");
  c->cd(2);
  latex2->SetTextSize(1.3*latex2->GetTextSize());
  latex2->DrawLatex(0.08,0.24,histtitle[1]);
  latex2->SetTextSize(0.9*latex2->GetTextSize());
  latex2->DrawLatex(0.07,0.4,"0.3 < p_{T}^{a} < 3.0 GeV/c");
  latex2->DrawLatex(0.07,0.33,"p_{T}^{b} > 0 GeV/c");
  latex2->SetTextSize(latex2->GetTextSize()/0.9);
  c->cd(3);
  latex2->DrawLatex(0.08,0.24,histtitle[2]);

  TLegend* legend2 = new TLegend(0.21,0.31,0.74,0.52);
  legend2->SetFillStyle(0);
  legend2->AddEntry(gr[0][3],"4.4 < #eta^{b} < 5.0","P");
  legend2->AddEntry(gr[4][3],"3.0 < #eta^{b} < 4.0","P");
  legend2->AddEntry(fit[0][3],"Exponential fits","L");
  c->cd(1);
  legend2->Draw("same");
