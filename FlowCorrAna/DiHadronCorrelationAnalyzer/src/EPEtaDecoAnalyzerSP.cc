...
void EPEtaDecoAnalyzerSP::beginRun(const edm::Run& iRun, const edm::EventSetup& iSetup)
{
...
void EPEtaDecoAnalyzerSP::endRun(const edm::Run& iRun, const edm::EventSetup& iSetup)
{
