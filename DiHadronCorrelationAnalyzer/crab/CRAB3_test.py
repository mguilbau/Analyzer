...
config.General.requestName = 'pp_Data_Ridge13TeV_test2'
config.General.workArea = 'pp_Data_Ridge13TeV_test2'

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
#config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = '$CMSSW_BASE/src/FlowCorrAna/DiHadronCorrelationAnalyzer/cfg/dihadroncorrelation_pp2015_mb_cfg.py'
