...
chargedepcorr_ana = cms.EDAnalyzer('ChargeDepCorrAnalyzerSP3',
  ...
  centmin = cms.int32(-1),
  centmax = cms.int32(-1),
  zvtxmin = cms.double(-15.),
  zvtxmax = cms.double(15.),
  zvtxbin = cms.double(30),
