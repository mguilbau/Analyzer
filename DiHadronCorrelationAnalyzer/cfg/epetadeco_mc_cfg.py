...
process.epetadeco_ana_HI_hfp.etaassmin = cms.double(4.0)
process.epetadeco_ana_HI_hfp.etaassmax = cms.double(5.0)
process.epetadeco_ana_HI_hfp.pttrgmin = cms.vdouble(0.5)
process.epetadeco_ana_HI_hfm.etaassmin = cms.double(-5.0)
process.epetadeco_ana_HI_hfm.etaassmax = cms.double(-4.0)
process.epetadeco_ana_HI_hfm.pttrgmin = cms.vdouble(0.5)
