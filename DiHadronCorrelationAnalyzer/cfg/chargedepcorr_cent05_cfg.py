...
process.chargedepcorr_ana_HI.centmax = cms.int32(10)
process.chargedepcorr_ana_HI.EffFileName = cms.string('TrackCorrections_HYDJET_5320_hiGenPixelTrk_cent05.root')
process.chargedepcorr_ana_HI.ReCenterFileName = cms.string('recenter_cent05_pttrg033_etaass445_eff1_zvtx1_bin01_new.root')
#process.chargedepcorr_ana_HI.EtaPhiFileName = cms.string('dNdetadphi_cent05_pttrg033_etaass445_eff0_bin02_new.root')
