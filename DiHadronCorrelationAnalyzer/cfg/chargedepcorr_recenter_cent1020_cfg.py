...
process.chargedepcorr_ana_HI.centmin = cms.int32(20)
process.chargedepcorr_ana_HI.centmax = cms.int32(40)
...
process.chargedepcorr_ana_HI.EffFileName = cms.string('TrackCorrections_HYDJET_5320_hiGenPixelTrk_cent1030.root')
#process.chargedepcorr_ana_HI.ReCenterFileName = cms.string('chargedepcorr_cent1020_pttrg033_ptassallweight_etaass445_recenter_eff0_v11.root')
#process.chargedepcorr_ana_HI.ReCenterFileName = cms.string('chargedepcorr.root')
