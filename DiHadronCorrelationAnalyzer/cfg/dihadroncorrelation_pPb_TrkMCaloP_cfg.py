...
process.corr_ana_pPb_TrkCalo.etatrgmin = cms.double(-2.4)
process.corr_ana_pPb_TrkCalo.etatrgmax = cms.double(0.0)
process.corr_ana_pPb_TrkCalo.etaassmin = cms.double(3.0)
process.corr_ana_pPb_TrkCalo.etaassmax = cms.double(5.0)
