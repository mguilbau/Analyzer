...
process.corr_ana_pPb.NEtaBins = cms.int32(128)
process.corr_ana_pPb.NPhiBins = cms.int32(128)
process.corr_ana_pPb.nmin = cms.int32(185)
process.corr_ana_pPb.nmax = cms.int32(220)

#process.corr_ana_pPb.chargeasymmin = cms.double(0.15)
#process.corr_ana_pPb.chargeasymmax = cms.double(0.2)
...
process.corr_ana_pPb_posneg = process.corr_ana_pPb.clone(
  TriggerID = cms.string('TrackP'),
  AssociateID = cms.string('TrackM')
)
...
#process.ana_posneg = cms.Path(process.hltHM185220*process.corr_ana_pPb_posneg)
