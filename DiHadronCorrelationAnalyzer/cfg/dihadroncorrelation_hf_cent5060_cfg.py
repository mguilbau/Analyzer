...
'/store/user/davidlw/HIMinBiasUPC/Skim_rereco_MB_pixeltracks_final_v2/9c1b4b9b6b9ff3e493a474ba7d01bc76/hiMB_1737_2_k8W.root'
                )
                            )
...
process.ana_step = cms.Path(process.hltHIMB*process.corr_ana_HI_hf)
#process.ana_step = cms.Path(process.corr_ana)
#process.corr_ana.IsCorr = cms.bool(False)
#process.corr_ana.IsDebug = cms.bool(True)
#process.ana_step = cms.Path(process.corr_ana)
process.corr_ana_HI_hf.centmin = cms.int32(100)
process.corr_ana_HI_hf.centmax = cms.int32(120)
