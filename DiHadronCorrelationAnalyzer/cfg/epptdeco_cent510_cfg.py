...
process.epptdeco_ana_HI.centmin = cms.int32(10)
process.epptdeco_ana_HI.centmax = cms.int32(20)
process.epptdeco_ana_HI.EffFileName = cms.string('TrackCorrections_HYDJET_5320_hiGenPixelTrk_cent510.root')
